...
By reverse-engineering the proprietary USB control transfers and emulating the official Blackmagic Ethernet Videohub Protocol (TCP Port 9990), this bridge allows you to control your legacy hardware using the official Blackmagic Videohub Control software and Bitfocus Companion—complete with real-time bidirectional status sync across all connected clients.
